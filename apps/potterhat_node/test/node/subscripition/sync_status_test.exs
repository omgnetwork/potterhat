...
defmodule PotterhatNode.SyncStatusTest do
  ...
  describe "start_link/2" do
    test "returns a pid", meta do
      ...
      {res, pid} = SyncStatus.start_link(meta.websocket_url, listener: listener_pid)
  ...
  describe "on receving websocket packets" do
    test "notifies the listener", meta do
      ...
      {:ok, _} = SyncStatus.start_link(meta.websocket_url, listener: listener_pid)
      ...
      assert {:event_received, :sync_status, _} = hd(events)
    end
  end
end
