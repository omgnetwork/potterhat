...
defmodule PotterhatNode.NewPendingTransactionTest do
  ...
  describe "start_link/2" do
    test "returns a pid", meta do
      ...
      {res, pid} = NewPendingTransaction.start_link(meta.websocket_url, listener: listener_pid)
  ...
  describe "on receving websocket packets" do
    test "notifies the listener", meta do
      ...
      {:ok, _} = NewPendingTransaction.start_link(meta.websocket_url, listener: listener_pid)
